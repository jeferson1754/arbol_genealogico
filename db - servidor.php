<?php
$servername = "sql208.epizy.com";         // Generalmente 'localhost'
$username = "epiz_32740026";                // Tu usuario de MySQL (por defecto en XAMPP es 'root')
$password = "eJWcVk2au5gqD";                     // Tu contraseña de MySQL (por defecto en XAMPP está vacía)
$dbname = "epiz_32740026_r_user";
